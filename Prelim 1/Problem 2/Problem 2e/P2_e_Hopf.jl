...
#u[1] = x; u[2] = y; u[3] = z
function P2_e(du,u,p,t)

#given non-dimentional parameters
    S= 105   #Selected S value, below Hopf point
    alpha_x=0.039;
    alpha_y=4.3^(-3);
    beta_x=6.1;
    beta_y=5.7;
...
prob = ODEProblem(P2_e,u0,tspan)     #Create an ODE problem for the Lorenz fxn
...
#result steady state XYZ resuolt
print("\n X_ss = ")
print(X_SS)
print("\n Y_ss = ")
print(Y_SS)
